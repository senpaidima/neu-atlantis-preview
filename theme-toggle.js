  ...
  var DIMENSIONS = [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "split",   label: "Split",       sub: "Text links, Welle pur rechts",            dot1: "#23423F", dot2: "#9FC3E1", cls: "hero-split" },
        { id: "fade",    label: "Fade",        sub: "Welle pur, Verlauf nur hinterm Text",     dot1: "#2E524E", dot2: "#D5E9EF", cls: "hero-fade" },
        { id: "banner",  label: "Banner",      sub: "Text oben, Welle als volles Bild-Band",   dot1: "#F1EBDF", dot2: "#5E8494", cls: "hero-banner" }
      ],
      allClasses: ["hero-split", "hero-fade", "hero-banner"]
    },
    {
      key: "na-nav",
      title: "Navigation",
